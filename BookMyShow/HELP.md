...
* [Spring Data Reactive Redis](https://docs.spring.io/spring-boot/3.5.12-SNAPSHOT/reference/data/nosql.html#data.nosql.redis)
...
* [Prometheus](https://docs.spring.io/spring-boot/3.5.12-SNAPSHOT/reference/actuator/metrics.html#actuator.metrics.export.prometheus)
